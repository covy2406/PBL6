        ...
        <ul className="categories-list">
          ...
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "SamSung"}
              value="SamSung"></input>
            <label className="categories-item__label" htmlFor="SamSung">
              SamSung
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Apple"}
              value="Apple"></input>
            <label className="categories-item__label" htmlFor="Apple">
              Apple
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Xiaomi"}
              value="Xiaomi"></input>
            <label className="categories-item__label" htmlFor="Xiaomi">
              Xiaomi
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Huawei"}
              value="Huawei"></input>
            <label className="categories-item__label" htmlFor="Huawei">
              Huawei
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Realmi"}
              value="Realmi"></input>
            <label className="categories-item__label" htmlFor="Realmi">
              Realmi
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Nokia"}
              value="Nokia"></input>
            <label className="categories-item__label" htmlFor="Nokia">
              Nokia
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Vivo"}
              value="Vivo"></input>
            <label className="categories-item__label" htmlFor="Vivo">
              Vivo
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handleBrandchange}
              checked={productBrand === "Oppo"}
              value="Oppo"></input>
            <label className="categories-item__label" htmlFor="Oppo">
              Oppo
            </label>
          </li>
        </ul>
        ...
        <ul className="categories-list">
          ...
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handlePriceChange}
              checked={priceRange === "0-2"}
              value="0-2"
            />
            <label className="categories-item__label" htmlFor="0-2">
              Dưới 2 triệu
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handlePriceChange}
              checked={priceRange === "2-4"}
              value="2-4"
            />
            <label className="categories-item__label" htmlFor="2-4">
              2 - 4 triệu
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handlePriceChange}
              checked={priceRange === "4-7"}
              value="4-7"
            />
            <label className="categories-item__label" htmlFor="4-7">
              4 - 7 triệu
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handlePriceChange}
              checked={priceRange === "7-13"}
              value="7-13"
            />
            <label className="categories-item__label" htmlFor="7-13">
              7 - 13 triệu
            </label>
          </li>
          <li className="categories-item">
            <input
              ...
              type="checkbox"
              onChange={handlePriceChange}
              checked={priceRange === "13+"}
              value="13+"
            />
            <label className="categories-item__label" htmlFor="13+">
              Trên 13 triệu
            </label>
          </li>
        </ul>
