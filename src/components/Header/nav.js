        ...
        <div className="grid">
            <nav className="header__navbar">
                ...
                <ul className="header__navbar-list ">
                    ...
                    <li className="header__navbar-item">
                        <Link to="/" className="header__navbar-item-link">
                            <i className="header__navbar-icon-right fa-regular fa-circle-question"></i>Trợ giúp
                        </Link>
                    </li>
                    ...
                    <li className="header__navbar-item header__navbar-item--bold">Đăng nhập</li> --> */}
                    {
                        ...
                        (
                            <li className="header__navbar-item header__navbar-user">
                                ...
                                <span className="header__navbar-user-name header__navbar-item--bold">{user.name}</span>
                ...
                <div className="header-with-search">
                    ...
                    <div className="header__search">
                        ...
                        <div className="header__search-select">
                            ...
                            <i className="header__search-select-icon fa-solid fa-angle-down"><AiOutlineDown/></i>

                            <ul className="header__search-option">
                                <li className="header__search-option-item header__search-option-item--active">
                                    <span>Trong Shop</span>
                                    <i className="fas fa-check"><AiOutlineCheck/></i>
                                </li>
                        ...
                        <button className="header__search-btn">
                            <i className="header__search-btn-icon fas fa-search"><BiSearchAlt2/></i>
                        </button>
                    </div>
                    ...
                    <div className="header__cart">
                        <div className="header__cart-wrap">
                            <i className="header__cart-icon fas fa-shopping-cart"><BsCart2/></i>
                            <span className="header__cart-notice">3</span>

                            {/* <!-- No cart: header__cart-list--no-cart --> */}
                            <div className="header__cart-list ">
                                <img src="./img/no_cart.png" alt="" className="header__cart-no-cart-img"></img>
                                ...
                                <ul className="header__cart-list-item">
                                    <li className="header__cart-item">
                                        <img src="./img/dienthoai.jpg" alt="" className="header__cart-img"></img>
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại siêu đẹp, siêu chất, lượng hàng đầu thị trường</h5>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Siêu đẹp, siêu mới, siêu bền</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại iphone</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại samsung</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại huawei</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại xiaomi</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                    ...
                                    <li className="header__cart-item">
                                        ...
                                        <div className="header__cart-item-info">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-item-name">Điện thoại oppo</h5>
                                                <div className="header__cart-item-price-wrap">
                                                    <span className="header__cart-item-price">2.000.000đ</span>
                                                    <span className="header__cart-item-multiply">x</span>
                                                    <span className="header__cart-item-quantity">2</span>
                                ...
                                <Link to="/" className="header__cart-view-cart btn btn--primary">Xem giỏ hàng</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="nav_home">
                    <ul>
                        <li className="home_link active">
                            <Link to="/" className="home_link_Link">Home</Link>
                        </li>
                        <li className="home_link">
                            <Link to="/product" className="home_link_Link">Product</Link>
                        </li>
                        <li className="home_link">
                            <Link to="/about" className="home_link_Link">Old Phone</Link>
                        </li>
                        <li className="home_link">
                            <Link to="/contact" className="home_link_Link">Contact</Link>
                        </li>
