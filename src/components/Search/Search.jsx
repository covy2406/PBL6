                        ...
                        return (
                            <div className='box' key={item.id}>
                                <div className='img_box'>
                                    ...
                                    <img className='product-main__item' src={`http://0.tcp.ap.ngrok.io:17403/${item.image}`} alt={item.name}></img>
                                    <div className='icon'>
                                        {
                                            isAuthenticated ?
                                        ...
                                        <li className='icon__link' onClick={() => view(item.id)}><Link to={`../Viewdetail/${item.id}`}><BsEye /></Link></li>
                                    </div>
                                </div>
                                <div className='detail'>
                                    ...
                                    <div className="home-product-item__price">
                                        ...
                                        <span className="home-product-item__price-current">{item.price} đ</span>
                                    </div>

                                    <div className="home-product-item__origin">
                                        <span className="home-product-item__brand">{item.shopName}</span>
                                        <span className="home-product-item__origin-name">{item.quantity}</span>
                                    </div>
                                </div>
                            </div>
                        )
