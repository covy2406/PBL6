...
const Viewdetails = () => {
  ...
  if (
    !productDetail.shop_products ||
    productDetail.shop_products.length === 0
  ) {
                ...
                <div className="box__image">
                  <div className="img-box">
                    <img
                      ...
                      src={`http://0.tcp.ap.ngrok.io:15234/${shop_products.image}`}
                  ...
                  <div className="box__image-select">
                    {listshop_product.map((product) => (
                      <div
                        ...
                        onClick={() =>
                          handleColorClick(product.color, product.image)
                        }>
                  ...
                  {shop_products ? (
                    <div>
                      ...
                      <div className="product__price">
                        {parseInt(shop_products.price).toLocaleString("vn-VN")}{" "}
                        đ
                      </div>
              ...
              <div container__comment>
                {comment.map((cmtItem, index) => (
                  <div className="container__comment-item" key={index}>
                    ...
                    <div className="container__commnet-item-write">
                      {cmtItem.feedback}
                    </div>
                  </div>
                ))}
